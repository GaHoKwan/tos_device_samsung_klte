...
.method addTask(Lcom/android/server/wm/Task;ZZ)Z
    ...
    .line 130
    iget-object v9, p0, Lcom/android/server/wm/TaskStack;->mStackBox:Lcom/android/server/wm/StackBox;
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/StackBox;->makeDirty()V
    ...
    .line 156
    iget-object v9, p1, Lcom/android/server/wm/Task;->mStack:Lcom/android/server/wm/TaskStack;

    iget-object v9, v9, Lcom/android/server/wm/TaskStack;->mStackBox:Lcom/android/server/wm/StackBox;
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/StackBox;->isFloatingStackBox()Z
    ...
    .line 159
    .local v5, "willBeFloating":Z
    :goto_2
    iget-object v9, p0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v9, v9, Lcom/android/server/wm/WindowManagerService;->mResizingMultiWindow:Z
    ...
    iget-object v8, v9, Lcom/android/server/wm/AppWindowToken;->allAppWindows:Lcom/android/server/wm/WindowList;
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/WindowStateAnimator;->destroySurfaceLocked()V
    ...
    .end local v4    # "wasFloating":Z
    .end local v5    # "willBeFloating":Z
    ...
    iget v2, v9, Lcom/android/server/wm/WindowManagerService;->mCurrentUserId:I
    ...
    .restart local v4    # "wasFloating":Z
    :cond_6
    move v5, v11
    ...
    .restart local v5    # "willBeFloating":Z
    .restart local v7    # "winNdx":I
    .restart local v8    # "windows":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/WindowState;>;"
    :cond_7
    ...
    invoke-virtual {v9, p1, p2, p3}, Lcom/android/server/wm/DisplayContent;->addTask(Lcom/android/server/wm/Task;ZZ)V
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/StackBox;->isHiddenStackBox()Z
    ...
    iget-object v10, p0, Lcom/android/server/wm/TaskStack;->mStackBox:Lcom/android/server/wm/StackBox;

    invoke-virtual {v9, v10, p2}, Lcom/android/server/wm/DisplayContent;->moveStackBox(Lcom/android/server/wm/StackBox;Z)Z
