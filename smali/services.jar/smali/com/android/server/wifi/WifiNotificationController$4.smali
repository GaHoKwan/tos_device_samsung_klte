...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    invoke-static {}, Lcom/android/server/wifi/WifiNotificationController;->access$1300()Landroid/net/Uri;
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiNotificationController;->access$1400(Lcom/android/server/wifi/WifiNotificationController;)Z
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/wifi/WifiNotificationController;->access$1602(Lcom/android/server/wifi/WifiNotificationController;J)J

    :cond_0
    iget-object v1, p0, Lcom/android/server/wifi/WifiNotificationController$4;->this$0:Lcom/android/server/wifi/WifiNotificationController;

    # setter for: Lcom/android/server/wifi/WifiNotificationController;->mLowSignal:Z
    invoke-static {v1, v0}, Lcom/android/server/wifi/WifiNotificationController;->access$1502(Lcom/android/server/wifi/WifiNotificationController;Z)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiNotificationController;->access$1700(Lcom/android/server/wifi/WifiNotificationController;)I

    move-result v3

    # invokes: Lcom/android/server/wifi/WifiNotificationController;->setNotificationVisible(ZIZI)V
    invoke-static {v1, v2, v3, v4, v4}, Lcom/android/server/wifi/WifiNotificationController;->access$1800(Lcom/android/server/wifi/WifiNotificationController;ZIZI)V
