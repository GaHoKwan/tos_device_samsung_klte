...
.method public onFinish()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$19200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
...
.method public onTick(J)V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$19000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/widget/TextView;
    ...
    iget-object v5, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$9;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;

    iget-object v5, v5, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    # --operator for: Landroid/net/wifi/p2p/WifiP2pService;->mLapseTime:I
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$18906(Landroid/net/wifi/p2p/WifiP2pService;)I
    ...
    iget-object v6, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$9;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
    ...
    invoke-static {v5, v6}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$13700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
