...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v0}, Landroid/media/RemoteControlClient;->access$1000(Landroid/media/RemoteControlClient;Landroid/media/IRemoteControlDisplay;)V
    ...
    invoke-static {v2, v0}, Landroid/media/RemoteControlClient;->access$1100(Landroid/media/RemoteControlClient;Landroid/media/IRemoteControlDisplay;)V
    ...
    invoke-static {v0, v1}, Landroid/media/RemoteControlClient;->access$1200(Landroid/media/RemoteControlClient;I)V
    ...
    invoke-static {v1, v0}, Landroid/media/RemoteControlClient;->access$1500(Landroid/media/RemoteControlClient;Landroid/media/IRemoteControlDisplay;)V
    ...
    invoke-static {v1, v0, v2, v3}, Landroid/media/RemoteControlClient;->access$1600(Landroid/media/RemoteControlClient;Landroid/media/IRemoteControlDisplay;II)V
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/RemoteControlClient;->access$1700(Landroid/media/RemoteControlClient;IJ)V
    ...
    invoke-static {v0}, Landroid/media/RemoteControlClient;->access$1800(Landroid/media/RemoteControlClient;)V
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/media/RemoteControlClient;->access$2000(Landroid/media/RemoteControlClient;IILjava/lang/Object;)V
    ...
    invoke-static {v3, v0, v1}, Landroid/media/RemoteControlClient;->access$2100(Landroid/media/RemoteControlClient;Landroid/media/IRemoteControlDisplay;Z)V
    ...
    # invokes: Landroid/media/RemoteControlClient;->onSetCommand(III)V
    invoke-static {v1, v2, v3, v0}, Landroid/media/RemoteControlClient;->access$2200(Landroid/media/RemoteControlClient;III)V
