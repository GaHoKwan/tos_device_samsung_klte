...
.method public getNfcSettingInterface()Landroid/nfc/INfcSetting;
    ...
    invoke-static {v3}, Landroid/nfc/INfcSetting$Stub;->asInterface(Landroid/os/IBinder;)Landroid/nfc/INfcSetting;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 522
    .local v2, "_result":Landroid/nfc/INfcSetting;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 522
    .end local v2    # "_result":Landroid/nfc/INfcSetting;
    :catchall_0
    move-exception v3
...
.method public getNfcUtilityInterface()Landroid/nfc/INfcUtility;
    ...
    invoke-static {v3}, Landroid/nfc/INfcUtility$Stub;->asInterface(Landroid/os/IBinder;)Landroid/nfc/INfcUtility;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 505
    .local v2, "_result":Landroid/nfc/INfcUtility;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 505
    .end local v2    # "_result":Landroid/nfc/INfcUtility;
    :catchall_0
    move-exception v3
