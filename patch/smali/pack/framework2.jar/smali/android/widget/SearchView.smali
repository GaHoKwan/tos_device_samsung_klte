...
.method private adjustDropDownSizeAndPosition()V
    ...
    invoke-virtual {v10}, Landroid/widget/SearchView$SearchAutoComplete;->getDropDownBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, v5}, Landroid/widget/SearchView$SearchAutoComplete;->setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v10, v9}, Landroid/widget/SearchView$SearchAutoComplete;->setDropDownHorizontalOffset(I)V

    iget-object v9, p0, Landroid/widget/SearchView;->mQueryTextView:Landroid/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v9, v4}, Landroid/widget/SearchView$SearchAutoComplete;->setDropDownWidth(I)V

    :goto_2
    iget-object v9, p0, Landroid/widget/SearchView;->mQueryTextView:Landroid/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v9}, Landroid/widget/SearchView$SearchAutoComplete;->isPopupShowing()Z
    ...
    invoke-virtual {v9}, Landroid/widget/SearchView$SearchAutoComplete;->showDropDownAfterLayout()V
    ...
    invoke-virtual {v9, v8}, Landroid/widget/SearchView$SearchAutoComplete;->setDropDownWidth(I)V
...
.method private getDecoratedHint(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v6, v0, v10}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    invoke-virtual {v5}, Landroid/widget/SearchView$SearchAutoComplete;->getTextSize()F
    ...
    invoke-virtual {v1, v9, v5, v4, v6}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    invoke-virtual {v3, v5, v10, v6, v7}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
