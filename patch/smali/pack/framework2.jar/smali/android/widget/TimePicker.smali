...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v13, v3}, Landroid/widget/ImageButton;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/widget/TimePicker;->getImportantForAccessibility()I
    ...
    invoke-virtual {v0, v13}, Landroid/widget/TimePicker;->setImportantForAccessibility(I)V

    :cond_9
    invoke-direct/range {p0 .. p0}, Landroid/widget/TimePicker;->setTextWatcher()V

    invoke-virtual/range {p0 .. p0}, Landroid/widget/TimePicker;->isWritingBuddyFeatureEnabled()Z
    ...
    invoke-virtual {v0, v13}, Landroid/widget/TimePicker;->setWritingBuddyEnabled(Z)V
...
.method public setEnabled(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/TimePicker;->setWritingBuddyEnabled(Z)V
...
.method public setIs24HourView(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p0}, Landroid/widget/TimePicker;->isWritingBuddyFeatureEnabled()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, v3}, Landroid/widget/TimePicker;->getWritingBuddy(Z)Lcom/samsung/android/writingbuddy/WritingBuddyImpl;
