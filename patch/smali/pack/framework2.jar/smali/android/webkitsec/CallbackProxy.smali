...
.method private declared-synchronized sendMessageToUiThreadSync(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Landroid/webkitsec/CallbackProxy;->sendMessage(Landroid/os/Message;)Z
...
.method public addMessageToConsole(Ljava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/CallbackProxy;->sendMessage(Landroid/os/Message;)Z
...
.method public createWindow(ZZ)Landroid/webkitsec/BrowserFrame;
    ...
    :goto_2
    invoke-virtual {p0, v4, v3, v1, v8}, Landroid/webkitsec/CallbackProxy;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public doUpdateVisitedHistory(Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-virtual {p0, v2, v0, v1, p1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v51 .. v51}, Landroid/webkitsec/ConsoleMessage$MessageLevel;->ordinal()I
...
.method public isSearchOptionAvailable(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v4}, Landroid/webkitsec/JsPromptResult;->getResult()Z
    ...
    invoke-virtual {v2}, Landroid/webkitsec/JsPromptResult;->getResult()Z
...
.method public onCloseWindow(Landroid/webkitsec/WebViewClassic;)V
    ...
    invoke-virtual {p0, v0, p1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public onDownloadStart(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Z
    ...
    invoke-virtual {p0, v2}, Landroid/webkitsec/CallbackProxy;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {p0, v1}, Landroid/webkitsec/CallbackProxy;->sendMessage(Landroid/os/Message;)Z
...
.method onIndexChanged(Landroid/webkitsec/WebHistoryItem;I)V
    ...
    invoke-virtual {p0, v1, p2, v2, p1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public onJsBeforeUnload(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v0}, Landroid/webkitsec/CallbackProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method onNewHistoryItem(Landroid/webkitsec/WebHistoryItem;)V
    ...
    invoke-virtual {p0, v1, p1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public onNotificationManagershowPrompt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/webkitsec/NotificationPermissions$Callback;)V
    ...
    invoke-virtual {p0, v4}, Landroid/webkitsec/CallbackProxy;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {p0, v3}, Landroid/webkitsec/CallbackProxy;->sendMessage(Landroid/os/Message;)Z
...
.method public onPrintPage()V
    ...
    invoke-virtual {p0, v0, v1, v1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(III)Landroid/os/Message;
...
.method public onProgressChanged(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/CallbackProxy;->sendEmptyMessage(I)Z
...
.method onReceivedTouchIconUrl(Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-virtual {p0, v3, v1, v2, p1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public onSavePassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)Z
    ...
    invoke-virtual {p0, v2, p4}, Landroid/webkitsec/CallbackProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method onSpellCheckFinish(I)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Landroid/webkitsec/CallbackProxy;->obtainMessage(III)Landroid/os/Message;
...
.method public setBingSearch()V
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/CallbackProxy;->obtainMessage(I)Landroid/os/Message;
...
.method protected shutdown()V
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/CallbackProxy;->removeCallbacksAndMessages(Ljava/lang/Object;)V
