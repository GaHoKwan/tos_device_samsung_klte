...
.method private dispatchUiEvents(Z)V
    ...
    invoke-virtual {v4, v6}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->removeMessages(I)V
...
.method private dispatchWebKitEvents(Z)V
    ...
    invoke-virtual {v6, v7}, Landroid/webkitsec/WebViewInputDispatcher$WebKitHandler;->removeMessages(I)V
...
.method private scheduleClickLocked()V
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->sendEmptyMessageDelayed(IJ)Z
...
.method private scheduleHitTestLocked(Landroid/webkitsec/WebViewInputDispatcher$DispatchEvent;)V
    ...
    invoke-virtual {v0, v2}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->removeMessages(I)V
    ...
    invoke-virtual {v1, v2, p1}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v1

    const-wide/16 v2, 0x20

    invoke-virtual {v0, v1, v2, v3}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private scheduleUiDispatchLocked()V
    ...
    invoke-virtual {v0, v2}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->sendEmptyMessage(I)Z
...
.method private scheduleWebKitDispatchLocked()V
    ...
    invoke-virtual {v0, v1}, Landroid/webkitsec/WebViewInputDispatcher$WebKitHandler;->sendMessageAtFrontOfQueue(Landroid/os/Message;)Z
    ...
    invoke-virtual {v0, v2}, Landroid/webkitsec/WebViewInputDispatcher$WebKitHandler;->sendEmptyMessage(I)Z
...
.method private unscheduleClickLocked()V
    ...
    invoke-virtual {v0, v1}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->removeMessages(I)V
...
.method private updateWebKitTimeoutLocked()V
    ...
    invoke-virtual {v1, v5}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->removeMessages(I)V
    ...
    invoke-virtual {v1, v5, v2, v3}, Landroid/webkitsec/WebViewInputDispatcher$UiHandler;->sendEmptyMessageAtTime(IJ)Z
