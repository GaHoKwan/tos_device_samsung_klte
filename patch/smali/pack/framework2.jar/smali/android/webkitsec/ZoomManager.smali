...
.method private setupZoomOverviewWidth(Landroid/webkitsec/WebViewCore$DrawData;I)Z
    ...
    invoke-virtual {v1}, Landroid/webkitsec/WebSettings;->getUseWideViewPort()Z
...
.method private zoomToReadingLevelOrMore()V
    ...
    invoke-virtual {v3, v2, v4}, Landroid/webkitsec/WebView;->scrollBy(II)V
...
.method public isDoubleTapEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/webkitsec/WebSettings;->getUseWideViewPort()Z
...
.method public onSizeChanged(IIII)V
    ...
    invoke-virtual {v4, v5}, Landroid/webkitsec/WebView;->post(Ljava/lang/Runnable;)Z
...
.method public updateMultiTouchSupport(Landroid/content/Context;)V
    ...
    :cond_1
    invoke-virtual {v2}, Landroid/webkitsec/WebSettings;->supportZoom()Z

    move-result v3

    if-eqz v3, :cond_5

    invoke-virtual {v2}, Landroid/webkitsec/WebSettings;->getBuiltInZoomControls()Z
