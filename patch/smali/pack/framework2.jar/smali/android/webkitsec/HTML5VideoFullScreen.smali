...
.method constructor <init>(Landroid/content/Context;IIZ)V
    ...
    invoke-virtual {p0, p2, p3, p4}, Landroid/webkitsec/HTML5VideoFullScreen;->init(IIZ)V
...
.method private prepareForFullScreen()V
    ...
    iget-object v0, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mProxy:Landroid/webkitsec/HTML5VideoViewProxy;

    invoke-virtual {p0, v0}, Landroid/webkitsec/HTML5VideoFullScreen;->prepareDataAndDisplayMode(Landroid/webkitsec/HTML5VideoViewProxy;)V
...
.method private toggleMediaControlsVisiblity()V
    ...
    :cond_1
    iget-boolean v0, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mPlayerBuffering:Z
...
.method private togglePlayPause()V
    ...
    invoke-virtual {p0}, Landroid/webkitsec/HTML5VideoFullScreen;->isPlaying()Z
    ...
    invoke-virtual {p0, v0}, Landroid/webkitsec/HTML5VideoFullScreen;->pauseAndDispatch(Landroid/webkitsec/HTML5VideoViewProxy;)V

    :goto_0
    return-void

    :cond_0
    invoke-virtual {p0}, Landroid/webkitsec/HTML5VideoFullScreen;->start()V
...
.method public enterFullScreenVideoState(ILandroid/webkitsec/HTML5VideoViewProxy;Landroid/webkitsec/WebViewClassic;)V
    ...
    iput-object p2, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mProxy:Landroid/webkitsec/HTML5VideoViewProxy;
    ...
    invoke-virtual {v2}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->getHolder()Landroid/view/SurfaceHolder;
    ...
    invoke-virtual {v2, v4}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->setFocusable(Z)V

    iget-object v2, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mVideoSurfaceView:Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;

    invoke-virtual {v2, v4}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->setFocusableInTouchMode(Z)V

    iget-object v2, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mVideoSurfaceView:Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;

    invoke-virtual {v2}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->requestFocus()Z

    new-instance v2, Landroid/widget/FrameLayout;

    iget-object v3, p0, Landroid/webkitsec/HTML5VideoFullScreen;->mProxy:Landroid/webkitsec/HTML5VideoViewProxy;
    ...
    invoke-virtual {v2, v4}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->setSecure(Z)V
...
.method public onPrepared(Landroid/media/MediaPlayer;)V
    ...
    invoke-virtual {v3, p0}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-virtual {v3}, Landroid/webkitsec/HTML5VideoFullScreen$VideoSurfaceView;->getHolder()Landroid/view/SurfaceHolder;
    ...
    invoke-virtual {p0}, Landroid/webkitsec/HTML5VideoFullScreen;->getStartWhenPrepared()Z
    ...
    :cond_7
    invoke-virtual {p0}, Landroid/webkitsec/HTML5VideoFullScreen;->requestAudioFocus()Z
    ...
    invoke-virtual {p0, v4}, Landroid/webkitsec/HTML5VideoFullScreen;->setStartWhenPrepared(Z)V
