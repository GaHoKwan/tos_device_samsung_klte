...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :try_start_1
    invoke-virtual {p0, v3}, Landroid/webkitsec/WebCoreThreadWatchdog$1;->removeMessages(I)V

    const/16 v3, 0x65

    invoke-virtual {p0, v3}, Landroid/webkitsec/WebCoreThreadWatchdog$1;->obtainMessage(I)Landroid/os/Message;

    move-result-object v3

    const-wide/32 v5, 0xea60

    invoke-virtual {p0, v3, v5, v6}, Landroid/webkitsec/WebCoreThreadWatchdog$1;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v0}, Landroid/webkitsec/WebView;->getWindowToken()Landroid/os/IBinder;
    ...
    invoke-virtual {v0, v3}, Landroid/webkitsec/WebView;->post(Ljava/lang/Runnable;)Z
