...
.field private static mIsExtendActionBar:Z
...
.method final attach(Landroid/content/Context;Landroid/app/ActivityThread;Landroid/app/Instrumentation;Landroid/os/IBinder;ILandroid/app/Application;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/CharSequence;Landroid/app/Activity;Ljava/lang/String;Landroid/app/Activity$NonConfigurationInstances;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1}, Lcom/samsung/android/multiwindow/MultiWindowStyle;->isMultiPhoneWindowNeeded()Z
...
.method public getMultiWindowStyle()Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/android/multiwindow/MultiWindowFacade;->getMultiWindowStyle(Landroid/os/IBinder;)Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    .line 4570
    .restart local v0    # "service":Lcom/samsung/android/multiwindow/MultiWindowFacade;
    :cond_1
...
.method public getWindowMode()I
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/multiwindow/MultiWindowFacade;->getMultiWindowStyle(Landroid/os/IBinder;)Lcom/samsung/android/multiwindow/MultiWindowStyle;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sput-boolean v2, Landroid/app/Activity;->mIsExtendActionBar:Z
...
.method protected onPause()V
    ...
    invoke-virtual {v2, p0}, Landroid/app/Application;->dispatchActivityPaused(Landroid/app/Activity;)V
...
.method protected tos_org_onResume()V
    ...
    .line 1137
    iput-boolean v10, p0, Landroid/app/Activity;->mCalled:Z

    .line 1138
    const/4 v2, 0x0

    .line 1140
    .local v2, "mIsEasyLauncher":Z
    invoke-virtual {p0}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;
    ...
    .line 1148
    :cond_0
    iget-object v7, p0, Landroid/app/Activity;->mActionBar:Lcom/android/internal/app/ActionBarImpl;
    ...
    .line 1150
    .local v5, "s":Landroid/app/StatusBarManager;
    invoke-virtual {v5, v9, v9}, Landroid/app/StatusBarManager;->setTransGradationModeColor(ZI)V
    ...
    invoke-virtual {v7}, Landroid/view/Window;->arrangeScaleStackBound()V

    .line 1175
    return-void

    .line 1152
    .end local v5    # "s":Landroid/app/StatusBarManager;
    :cond_1
    ...
    invoke-virtual {v7, v8, v3, v10}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    sget-boolean v7, Landroid/app/Activity;->mIsExtendActionBar:Z
    ...
    .line 1163
    .restart local v5    # "s":Landroid/app/StatusBarManager;
    const-string v7, "#26000000"

    invoke-static {v7}, Landroid/graphics/Color;->parseColor(Ljava/lang/String;)I

    move-result v7

    invoke-virtual {v5, v10, v7}, Landroid/app/StatusBarManager;->setTransGradationModeColor(ZI)V

    .line 1164
    const-string v7, "Activity"

    const-string v8, "setTransGradationMode to true"
