...
.method constructor <init>(Landroid/app/ContextImpl;Landroid/content/pm/IPackageManager;)V
    ...
    iput-object v0, p0, Landroid/app/ApplicationPackageManager;->mPersonaPolicyManager:Landroid/os/PersonaPolicyManager;
...
.method public getCSCPackageItemIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v6}, Landroid/app/ActivityThread;->getCSCAppIconMap()Landroid/util/ArrayMap;

    move-result-object v0

    .line 899
    .local v0, "cscIconMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
...
.method public getCSCPackageItemText(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    const-string v8, "com.sec.android.app.latin.launcher.stk"
    ...
    const-string v8, "com.sec.android.app.latin.launcher.stk.StkShortcutWidget"
    ...
    invoke-virtual {v8}, Landroid/app/ActivityThread;->getCSCAppStringMap()Landroid/util/ArrayMap;

    move-result-object v0

    .line 865
    .local v0, "cscStringMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    invoke-virtual {v0}, Landroid/util/ArrayMap;->size()I
...
.method public getDefaultActivityIcon()Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v0, Landroid/content/res/Resources;->mContext:Landroid/content/Context;
...
.method public tos_org_getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;
    ...
    iget-object v4, v3, Landroid/app/ContextImpl;->mMainThread:Landroid/app/ActivityThread;
    ...
    invoke-virtual {v4, v3, v5, v6, v7}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    iput-boolean v3, v1, Landroid/content/res/Resources;->mNeedBadge:Z

    .line 988
    :cond_1
    iget v3, p1, Landroid/content/pm/ApplicationInfo;->icon:I

    iput v3, v1, Landroid/content/res/Resources;->icon:I
    ...
    .line 993
    iget-object v3, p0, Landroid/app/ApplicationPackageManager;->mPersonaPolicyManager:Landroid/os/PersonaPolicyManager;
    ...
    invoke-virtual {v0, v3}, Landroid/os/PersonaManager;->getPersonaService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/os/PersonaPolicyManager;

    iput-object v3, p0, Landroid/app/ApplicationPackageManager;->mPersonaPolicyManager:Landroid/os/PersonaPolicyManager;
    ...
    invoke-virtual {v3}, Landroid/os/PersonaPolicyManager;->isBadgeRequired()Z

    move-result v3

    iput-boolean v3, v1, Landroid/content/res/Resources;->mIsBadgeRequired:Z

    .line 1001
    :cond_3
    iget-object v3, p0, Landroid/app/ApplicationPackageManager;->mContext:Landroid/app/ContextImpl;

    iput-object v3, v1, Landroid/content/res/Resources;->mContext:Landroid/content/Context;

    .line 1004
    iget-object v3, p1, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    iput-object v3, v1, Landroid/content/res/Resources;->mPackageName:Ljava/lang/String;

    .line 1005
    iget v3, p1, Landroid/content/pm/ApplicationInfo;->icon:I

    iput v3, v1, Landroid/content/res/Resources;->mAppIconResId:I
...
.method public installPackageForMDM(Landroid/net/Uri;Landroid/content/pm/IPackageInstallObserver;IILjava/lang/String;)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/content/pm/IPackageManager;->installPackageForMDM(Landroid/net/Uri;Landroid/content/pm/IPackageInstallObserver;IILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setApplicationEnabledSettingWithList(Ljava/util/List;II)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/content/pm/IPackageManager;->setApplicationEnabledSettingWithList(Ljava/util/List;IIILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
