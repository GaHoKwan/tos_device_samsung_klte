...
.method public listen(Z)V
    ...
    invoke-interface {v1, v2, p1}, Landroid/bluetooth/IBluetoothGatt;->serverListen(IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setAdvParams(II)Z
    .locals 5
    .param p1, "advMinInt"    # I
    .param p2, "advMaxInt"    # I
    ...
    const-string v4, "setAdvParams()advMinInt"
    ...
    const-string v3, "min interval is greater than max interval"
    ...
    invoke-interface {v2, v3, p1, p2}, Landroid/bluetooth/IBluetoothGatt;->setAdvParams(III)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setServerAdvData(ZZZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[Ljava/lang/Byte;)V
    ...
    const-string v2, "setServerAdvData()"
    ...
    invoke-interface/range {v1 .. v9}, Landroid/bluetooth/IBluetoothGatt;->setServerAdvData(IZZZIII[B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
