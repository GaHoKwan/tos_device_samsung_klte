...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$7802(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$7902(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v1, v7}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$5902(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v1, v7}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$ProvisionDiscoveryState;
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$6400(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/os/PowerManager;
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$9100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$UserAuthorizingNegotiationRequestState;

    move-result-object v2

    # invokes: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$9200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$9400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$UserAuthorizingInviteRequestState;
    ...
    .line 1979
    .end local v7    # "config":Landroid/net/wifi/p2p/WifiP2pConfig;
    .end local v12    # "group":Landroid/net/wifi/p2p/WifiP2pGroup;
    .end local v17    # "owner":Landroid/net/wifi/p2p/WifiP2pDevice;
    :sswitch_8
    move-object/from16 v0, p1
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$7900(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v1, v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$9900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$10100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$NfcProvisionState;
