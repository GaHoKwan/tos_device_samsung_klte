...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$22700(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static/range {v15 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$22800(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static/range {v16 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$10700(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$LinkMonitoringState;
    ...
    invoke-static/range {v16 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$9000(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$OnlineState;
    ...
    invoke-static/range {v16 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$9200(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    # ++operator for: Landroid/net/wifi/WifiWatchdogStateMachine;->mRssiFetchToken:I
    invoke-static/range {v18 .. v18}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$9204(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23100()J
    ...
    invoke-static {}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23200()I
    ...
    invoke-static {v15}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23202(I)I
    ...
    # invokes: Landroid/net/wifi/WifiWatchdogStateMachine;->logd(Ljava/lang/String;)V
    invoke-static {v0, v15}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23300(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V

    .line 4540
    :cond_4
    # getter for: Landroid/net/wifi/WifiWatchdogStateMachine;->mCurrentApDefault:Z
    invoke-static {}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$21400()Z
    ...
    invoke-static {}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23400()I
    ...
    invoke-static {v15}, Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;->access$11600(Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;)J
    ...
    # invokes: Landroid/net/wifi/WifiWatchdogStateMachine;->logd(Ljava/lang/String;)V
    invoke-static/range {v15 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23500(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v15}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$10100(Landroid/net/wifi/WifiWatchdogStateMachine;)V
    ...
    invoke-static {v15, v10, v11}, Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;->access$11602(Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;J)J
    ...
    # invokes: Landroid/net/wifi/WifiWatchdogStateMachine;->logd(Ljava/lang/String;)V
    invoke-static/range {v15 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$23800(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$11300(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$WaitingSwitchState;

    move-result-object v16

    # invokes: Landroid/net/wifi/WifiWatchdogStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v15 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$24000(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
