...
.method private displayNotification()V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$13900(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$14100(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/app/NotificationManager;
    ...
    invoke-static {v3, v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$14102(Landroid/net/wifi/WifiWatchdogStateMachine;Landroid/app/NotificationManager;)Landroid/app/NotificationManager;
...
.method public writeResults()V
    ...
    # getter for: Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v6}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$13900(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$14000(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/text/SimpleDateFormat;
    ...
    # getter for: Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$13900(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
