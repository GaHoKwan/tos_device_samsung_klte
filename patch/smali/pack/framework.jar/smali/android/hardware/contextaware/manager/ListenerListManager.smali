...
.method public final getUsedServiceCount(Ljava/lang/String;)I
    ...
    .line 132
    .local v0, "count":I
    iget-object v4, p0, Landroid/hardware/contextaware/manager/ListenerListManager;->mListenerList:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 135
    .local v2, "key":I
    invoke-virtual {v3}, Landroid/hardware/contextaware/manager/ContextAwareService$Listener;->getServices()Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final getUsedSubCollectionCount(Ljava/lang/String;)I
    ...
    .line 153
    .local v1, "count":I
    iget-object v8, p0, Landroid/hardware/contextaware/manager/ListenerListManager;->mListenerList:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    check-cast v7, Landroid/hardware/contextaware/manager/ContextAwareService$Listener;

    .line 155
    .local v7, "listener":Landroid/hardware/contextaware/manager/ContextAwareService$Listener;
    invoke-virtual {v7}, Landroid/hardware/contextaware/manager/ContextAwareService$Listener;->getServices()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .end local v7    # "listener":Landroid/hardware/contextaware/manager/ContextAwareService$Listener;
    :cond_2
    return v1
.end method
