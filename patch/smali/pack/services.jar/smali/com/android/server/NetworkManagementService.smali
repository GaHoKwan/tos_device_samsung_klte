...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    iput v5, p1, Landroid/net/wifi/WifiConfiguration;->maxclient:I
    ...
    const-string/jumbo v7, "wifiConfig.vendorIE = "
    ...
    const-string/jumbo v7, "vendorIE = "
    ...
    iput v5, p1, Landroid/net/wifi/WifiConfiguration;->wpsStatus:I

    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    const-string/jumbo v6, "softap"
    ...
    invoke-direct {v9, v10}, Lcom/android/server/NativeDaemonConnector$SensitiveArg;-><init>(Ljava/lang/Object;)V

    aput-object v9, v7, v8

    const/4 v8, 0x5

    iget v9, p1, Landroid/net/wifi/WifiConfiguration;->channel:I
    ...
    iget v9, p1, Landroid/net/wifi/WifiConfiguration;->maxclient:I
